...
\usepackage[bicaption,lists]{bicaption} % 解决图标题中引用的参考文献在插图清单中显示的问题
\captionsetup[figure][bi-first]{name=图,list=yes,justification=centering,labelsep=quad,skip=4pt}  % 中文标题进入目录
\captionsetup[figure][bi-second]{name=Fig.,list=no,justification=centering,labelsep=quad}  % 英文标题不进目录
