...
\figurecaption{无参考文献引用的图标题示例}{Example of a figure caption without reference citation}
\label{figure1-0}
\end{figure}
...
\centering
\includegraphics[width=0.8\linewidth]{img/section1/立体观测网.png}
\vspace{4pt} %有参考文献需要手打插入一个垂直间距，以和其他图例保持格式一致
\bicaption[有参考文献引用的图标题示例]%有参考文献需要使用bicaption来实现
{有参考文献\cite{吴立新2020透明海洋立体观测网构建}引用的图标题示例}
{Example of a figure caption with reference citation\cite{吴立新2020透明海洋立体观测网构建}}
\label{figure1-0}
\end{figure}
